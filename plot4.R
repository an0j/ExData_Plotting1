...
with(subHouseholdConsumption, plot(dateTime, Voltage, type = "l", xlab = "datetime",
                                   ylab = "Voltage"))

with(subHouseholdConsumption, plot(dateTime, Sub_metering_1, type = "l", xlab = "",
                                   ylab = "Energy sub metering"))

with(subHouseholdConsumption, lines(dateTime, Sub_metering_2, type = "l", col= "red"))
with(subHouseholdConsumption, lines(dateTime, Sub_metering_3, type = "l", col= "blue"))

legend(c("topright"), c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       lty= 1, lwd=2, col = c("black", "red", "blue"))

with(subHouseholdConsumption, plot(dateTime, Global_reactive_power, type = "l", 
                                   xlab = "datetime"))
